...
int main (int argc, char *argv[])
{
	if (argc < 3)
		...
		cout << "Usage: " << argv[0]
			...
			<< " alpha gamma nscales fscale zoom_factor"
	...
	else
	{
		...
		if (correct1 && correct2 && nx == nx1 && ny == ny1)
		{
			...
			if(verbose) cout << endl << "ncores:" << nproc << " alpha:" << alpha
				<< " gamma:" << gamma << " scales:" << nscales << " fcale:" << fscale
				<< " nu:" << zfactor << " TOL:" << TOL << " inner:" << initer
				<< " outer:" << outiter << endl;
